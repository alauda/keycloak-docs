...
The `KeycloakRealmImport` CRD is the preferred method for initial Realm provisioning in Kubernetes deployments. See [Manage Realms](../functions/20-manage_realms.mdx) for details.
...
<Directive type="warning" title="KeycloakRealmImport Is a One-Shot Import">
